...
const ImageItem = ({ imageSrc, onZoom, onRequestClose, onLongPress, delayLongPress, swipeToCloseEnabled = true, doubleTapToZoomEnabled = true, isFocused = true, }) => {
    ...
    useEffect(() => {
        ...
        if (!isFocused) {
            ...
            if (scrollViewRef.current) {
                ...
                (_a = scrollResponder) === null || _a === void 0 ? void 0 : _a.scrollResponderZoomTo({
                    x: 0,
                    y: 0,
                    width: SCREEN_WIDTH,
